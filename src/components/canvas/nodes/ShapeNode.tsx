    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          clipPath,
          boxShadow:
            isDiamond || isPolygon || isStar || isLine || isArrow
              ? 'none'
              : '0 4px 20px -2px rgb(0 0 0 / 0.1), 0 0 3px rgb(0 0 0 / 0.05)',
      ...
      >
        {(isDiamond || isPolygon || isStar) && (
          <div
            ...
            style={{
              filter: `drop-shadow(0 0 ${borderWidth ?? 0}px ${borderColor}) drop-shadow(0 4px 6px rgba(0,0,0,0.1))`,
            }}
          ></div>
        )}
