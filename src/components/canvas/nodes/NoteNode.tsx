    ...
    <>
      ...
      >
        ...
        <Handle
          ...
          className="w-3 h-3 bg-yellow-500 border-2 border-yellow-200 opacity-0 group-hover:opacity-100 transition-transform hover:scale-125 z-10"
        />
        ...
        <div className="bg-yellow-200/50 dark:bg-yellow-800/50 h-7 w-full flex items-center px-3 cursor-grab drag-handle border-b border-yellow-300/30 dark:border-yellow-700/30">
          <span className="text-[10px] uppercase font-bold text-yellow-800/70 dark:text-yellow-400/70">
            Note
          </span>
        </div>
