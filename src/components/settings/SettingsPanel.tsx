          ...
          <Tabs defaultValue="general" className="w-full flex flex-col h-full">
            <div className="border-b px-4">
              <TabsList className="h-14 bg-transparent w-full justify-start gap-4 p-0">
                <TabsTrigger
                  value="ai"
                  className="gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:shadow-none data-[state=active]:bg-transparent px-4 font-medium text-muted-foreground data-[state=active]:text-foreground h-full transition-none"
                >
                    ...
                    <FieldLabel label="API Key">
                      <PasswordInput
                        ...
                        onChange={(v) =>
                          setConfig({
                            ...config,
                            ai: { ...config.ai, openai: { ...config.ai.openai, api_key: v } },
                          })
                        }
                        placeholder="sk-..."
                      />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setConfig({
                              ...
                              ai: {
                                ...config.ai,
                                openai: { ...config.ai.openai, model: e.target.value },
                              },
                            })
                          }
                        />
                      ...
                      <FieldLabel label="Max Tokens">
                        <Input
                          type="number"
                          value={
                            config.ai.openai.max_tokens === 0 ? '' : config.ai.openai.max_tokens
                          }
                    ...
                    <FieldLabel label="API Key">
                      <PasswordInput
                        ...
                        onChange={(v) =>
                          setConfig({
                            ...config,
                            ai: { ...config.ai, anthropic: { ...config.ai.anthropic, api_key: v } },
                          })
                        }
                        placeholder="sk-ant-..."
                      />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setConfig({
                              ...
                              ai: {
                                ...config.ai,
                                anthropic: { ...config.ai.anthropic, model: e.target.value },
                              },
                            })
                          }
                        />
                      ...
                      <FieldLabel label="Max Tokens">
                        <Input
                          type="number"
                          value={
                            config.ai.anthropic.max_tokens === 0
                              ? ''
                              : config.ai.anthropic.max_tokens
                          }
                          placeholder="0 (Unlimited)"
                          onChange={(e) =>
                            setConfig({
                  ...
                  <div className="space-y-4">
                    <FieldLabel label="API Key">
                      <PasswordInput
                        ...
                        onChange={(v) =>
                          setConfig({
                            ...config,
                            ai: { ...config.ai, kimi: { ...config.ai.kimi, api_key: v } },
                          })
                        }
                        placeholder="sk-..."
                      />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setConfig({
                              ...
                              ai: {
                                ...config.ai,
                                kimi: { ...config.ai.kimi, model: e.target.value },
                              },
                            })
                          }
                        />
                      ...
                      <FieldLabel label="Max Tokens">
                        <Input
                          type="number"
                          value={config.ai.kimi.max_tokens === 0 ? '' : config.ai.kimi.max_tokens}
                          placeholder="0 (Unlimited)"
                          onChange={(e) =>
                            setConfig({
                              ...config,
                ...
                >
                  <div className="space-y-4">
                    ...
                    <FieldLabel label="API Key">
                      <PasswordInput
                        ...
                        onChange={(v) =>
                          setConfig({
                            ...config,
                            ai: { ...config.ai, opencode: { ...config.ai.opencode, api_key: v } },
                          })
                        }
                        placeholder="sk-..."
                      />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <FieldLabel label="Model">
                        <Input
                          value={config.ai.opencode.model}
                          onChange={(e) =>
                            setConfig({
                              ...config,
                              ai: {
                                ...config.ai,
                                opencode: { ...config.ai.opencode, model: e.target.value },
                              },
                            })
                          }
                        />
                      ...
                      <FieldLabel label="Max Tokens">
                        <Input
                          type="number"
                          value={
                            config.ai.opencode.max_tokens === 0 ? '' : config.ai.opencode.max_tokens
                          }
                          placeholder="0 (Unlimited)"
                          onChange={(e) =>
                            setConfig({
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(c) =>
                        setConfig({
                          ...config,
                          ai: { ...config.ai, local: { ...config.ai.local, enabled: c } },
                        })
                      }
                    />
                  </div>
                ...
                <SectionCard title="Appearance" desc="Customize the look and feel of Weave.">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 border-t pt-8">
                      ...
                      <div className="space-y-3">
                        {Object.entries(activeTheme.colors).map(([key, value]) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3">
                              <span className="text-xs font-mono uppercase text-muted-foreground bg-muted/50 px-1.5 py-0.5 rounded">
                                {value}
                              </span>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    updateTheme(activeThemeId, {
                                      colors: { ...activeTheme.colors, [key]: e.target.value },
                                    })
                                  }
                    ...
                    <div className="space-y-8">
                      <div>
                        <h4 className="text-sm font-semibold border-b pb-2 mb-5">
                          Structural Styles
                        </h4>
                        <div className="space-y-4">
                          <FieldLabel label="Font Family">
                            <Select
                              ...
                              onValueChange={(v) =>
                                updateTheme(activeThemeId, { fontFamily: v as FontFamily })
                              }
                            >
                              <SelectTrigger>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <FieldLabel label="Border Radius">
                              <Select
                                disabled={!activeThemeId.startsWith('custom-')}
                                value={activeTheme.borderRadius || '0.5rem'}
                                onValueChange={(v) =>
                                  updateTheme(activeThemeId, { borderRadius: v as BorderRadius })
                                }
                              >
                                <SelectTrigger>
                            ...
                            <FieldLabel label="Border Width">
                              <Select
                                disabled={!activeThemeId.startsWith('custom-')}
                                value={activeTheme.borderWidth || '1px'}
                                onValueChange={(v) =>
                                  updateTheme(activeThemeId, { borderWidth: v as BorderWidth })
                                }
                              >
                                <SelectTrigger>
                          ...
                          <div className="space-y-3">
                            <div className="flex gap-2">
                              ...
                              <Button
                                ...
                                size="icon"
                                onClick={() =>
                                  updateTheme(activeThemeId, { backgroundImage: null })
                                }
