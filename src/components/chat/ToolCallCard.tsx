...
export function ToolCallCard({ call }: ToolCallCardProps) {
  ...
  return (
    <div className="my-2 border rounded-lg overflow-hidden bg-card/50 text-sm">
      <div 
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-foreground">
            <Wrench className="w-3.5 h-3.5 inline mr-1.5 text-muted-foreground" />
      ...
      {expanded && (
        <div className="px-3 py-2 border-t bg-muted/30">
          <div className="mb-2">
            ...
            <pre className="mt-1 p-2 bg-background rounded border text-[11px] font-mono overflow-x-auto text-foreground">
