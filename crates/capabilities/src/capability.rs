...
impl Capability {
    pub fn new(id: &str, version: ArtifactVersion, perms: Vec<String>, constraints: Vec<String>, effects: Vec<String>) -> Self {
        Self {
            id: id.to_string(),
            version,
    ...
    pub fn deserialize_input<'a, I: Deserialize<'a>>(&self, data: &'a [u8]) -> Result<I, CapabilityError> {
