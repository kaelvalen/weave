    ...
    fn create_builtin_plugins() -> Vec<Plugin> {
        vec![
            ...
            PluginBuilder::builtin("com.weave.builtin.coder", "Coder AI")
                ...
                .capability("coder.list_dir", r#"{"path":".","depth":2,"show_hidden":false}"#, "Print directory tree structure respecting .gitignore")
                .capability("coder.symbols", r#"{"path":"..."}"#, "Extract function and structural symbols from a file")
                .capability("coder.history", r#"{"path":"..."}"#, "List versioned backups for a file")
                .capability("coder.undo", r#"{"path":"..."}"#, "Rollback a file to its previous backup version")
                .capability("coder.redo", r#"{"path":"..."}"#, "Roll forward a file to its next backup version")
                .capability("coder.search", r#"{"query":"...","directory":"."}"#, "Search for pattern/substring across workspace")
                .capability("coder.find_references", r#"{"symbol":"...","directory":"."}"#, "Find occurrences of a symbol across files")
                .capability("coder.rename_symbol", r#"{"path":"...","old_name":"...","new_name":"..."}"#, "Rename variable/symbol in a file")
                .capability("coder.git_status", r#"{"directory":"."}"#, "Get short git status")
                .capability("coder.git_diff", r#"{"directory":"."}"#, "Get git diff")
                .capability("coder.git_commit", r#"{"directory":".","message":"..."}"#, "Commit staged changes")
