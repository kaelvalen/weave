...
pub trait RegisteredPlugin: Send + Sync {
    ...
    fn execute(&self, capability: &str, params: Value, ctx: &ExecutionContext) -> Result<Value, WeaveError>;
}
...
impl PluginRegistry {
    ...
    pub fn execute(&self, plugin_id: &str, capability: &str, params: Value, ctx: &ExecutionContext) -> Result<Value, WeaveError> {
