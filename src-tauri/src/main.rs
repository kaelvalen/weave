...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            weave::commands::plugin::plugin_install_from_github_release,
            ...
            weave::commands::llama_swap::llama_swap_status,
            weave::commands::llama_swap::llama_swap_start,
            weave::commands::llama_swap::llama_swap_stop,
